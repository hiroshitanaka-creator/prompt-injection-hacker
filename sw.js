...
const APP_SHELL = [
  "./", "./index.html", `./styles.css?v=${VERSION}`, `./css/story.css?v=${VERSION}`, `./css/iphone-ux.css?v=${VERSION}`, `./css/expansion.css?v=${VERSION}`,
  ...["difficulty", "hint-system", "defense-analyzer", "companion", "epilogue", "story-data", "story", "ux-guide", "expansion-data", "expansion-engine", "expansion-save", "expansion-companion", "expansion-story-data", "expansion-story", "expansion-ui", "app"].map(name => `./js/${name}.js?v=${VERSION}`),
